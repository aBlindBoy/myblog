...
public class MessageInfo implements Serializable{
	...
	private static final long serialVersionUID = -4847272198873544421L;
	...
	public String toString() {
		return "MessageInfo [messageId=" + messageId + ", messageContent=" + messageContent + ", messageTime="
				+ messageTime + ", messageName=" + messageName + ", messageMark=" + messageMark + "]";
	}
